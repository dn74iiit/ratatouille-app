...
nb2_cells = [
    ...
    },
    {
        ...
        "source": [
            ...
            "\n",
            "    system_instruction = (\n",
            "        'You are a Michelin-star master chef specializing in Indian vegetarian cuisine. '\n",
            "        'Write a highly detailed, appetizing recipe for a ' + style + ' dish under INR ' + str(budget) + ' per serving.\\n'\n",
            "        'First, provide a restaurant-style title using ONLY the provided ingredients. '\n",
            "        'Do NOT invent extra ingredients not in the list.\\n'\n",
            "        'Then, provide clear step-by-step Indian cooking directions using proper culinary techniques.\\n'\n",
            "        'CRITICAL RULES:\\n'\n",
            "        '1. All raw ingredients (especially dal, rice, legumes) must be explicitly cooked in the instructions.\\n'\n",
            "        '2. Do not change the ingredient quantities provided.\\n'\n",
            "        '3. Do NOT hallucinate or add extra ingredients not in the list.\\n'\n",
            "        '4. Do NOT include Notes, Tips, or conversational text. Stop after the final serving step.'\n",
            "    )\n",
            "\n",
            "    prompt = (\n",
